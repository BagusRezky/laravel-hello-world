...
<body>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row row-cols-1 row-cols-md-1 g-4">
            ...
            <a href="/program/mengurangi kerusakan di laptop" class="col categoryName">
              <div class="card h-100">
                  <h5 class="card-title text-center">mengurangi kerusakan di laptop</h5>
              </div>
            </a>
            <a href="/program/cara menggunakan laravel" class="col categoryName">
              <div class="card h-100">
                  <h5 class="card-title text-center">cara menggunakan laravel</h5>
              </div>
            </a>
        </div>
    </div>

...
<body>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row row-cols-1 row-cols-md-1 g-4">
            ...
            <a href="/category/Asus" class="col categoryName">
              <div class="card h-100">
                  <h5 class="card-title text-center">Asus</h5>
              </div>
            </a>
            <a href="/category/Lenovo Thinkpad" class="col categoryName">
              <div class="card h-100">
                  <h5 class="card-title text-center">Lenovo Thinkpad</h5>
              </div>
            </a>
            <a href="/category/Hp" class="col categoryName">
              <div class="card h-100">
                  <h5 class="card-title text-center">Hp</h5>
              </div>
            </a>
        </div>
    </div>
